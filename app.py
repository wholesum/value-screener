...
# ------------------------------------------------------------
# ENDPOINTS (same as before, with try/except)
# ------------------------------------------------------------
# (I'm omitting the full endpoint code here for brevity – 
#  it's identical to the previous working version. 
#  Please paste the full endpoints from the last complete app.py I gave you.)
# But to be safe, I'll include them in the final answer.